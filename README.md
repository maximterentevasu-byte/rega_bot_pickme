...
- `Зарегистрироваться` запрашивает контакт, сохраняет Telegram ID участника по порядку.
- `Список участников` выводит список от 1 до N.
- `Отказаться от участия` запрашивает подтверждение, потом контакт и удаляет участника по ID.
